...
contains
  ...
  subroutine chm_diags_inti
    ...
    bulkaero_species(1:15) = (/ id_dst01, id_dst02, id_dst03, id_dst04, &
...
! JHYoon
    call addfld('so4_a1_logm', 'kg/kg ',pver, 'A','so4_a1 log concentration', phys_decomp)
    call addfld('pom_a1_logm', 'kg/kg ',pver, 'A','pom_a1 log concentration', phys_decomp)
    call addfld('soa_a1_logm', 'kg/kg ',pver, 'A','soa_a1 log concentration', phys_decomp)
    call addfld('dst_a1_logm', 'kg/kg ',pver, 'A','dst_a1 log concentration', phys_decomp)
    call addfld('ncl_a1_logm', 'kg/kg ',pver, 'A','ncl_a1 log concentration', phys_decomp)
    call addfld('bc_a1_logm', 'kg/kg ',pver, 'A','bc_a1 log concentration', phys_decomp)
    call addfld('num_a1_logm', 'kg/kg ',pver, 'A','num_a1 log concentration', phys_decomp)

    call addfld('so4_a2_logm', 'kg/kg ',pver, 'A','so4_a2 log concentration', phys_decomp)
    call addfld('soa_a2_logm', 'kg/kg ',pver, 'A','soa_a2 log concentration', phys_decomp)
    call addfld('ncl_a2_logm', 'kg/kg ',pver, 'A','ncl_a2 log concentration', phys_decomp)
    call addfld('num_a2_logm', 'kg/kg ',pver, 'A','num_a2 log concentration', phys_decomp)

    call addfld('so4_a3_logm', 'kg/kg ',pver, 'A','so4_a3 log concentration', phys_decomp)
    call addfld('dst_a3_logm', 'kg/kg ',pver, 'A','dst_a3 log concentration', phys_decomp)
    call addfld('ncl_a3_logm', 'kg/kg ',pver, 'A','ncl_a3 log concentration', phys_decomp)
    call addfld('num_a3_logm', 'kg/kg ',pver, 'A','num_a3 log concentration', phys_decomp)

    call addfld('so4_a1_logv', 'kg/kg ',pver, 'A','so4_a1 log^2 concentration', phys_decomp)
    call addfld('pom_a1_logv', 'kg/kg ',pver, 'A','pom_a1 log^2 concentration', phys_decomp)
    call addfld('soa_a1_logv', 'kg/kg ',pver, 'A','soa_a1 log^2 concentration', phys_decomp)
    call addfld('dst_a1_logv', 'kg/kg ',pver, 'A','dst_a1 log^2 concentration', phys_decomp)
    call addfld('ncl_a1_logv', 'kg/kg ',pver, 'A','ncl_a1 log^2 concentration', phys_decomp)
    call addfld('bc_a1_logv', 'kg/kg ',pver, 'A',' bc_a1 log^2 concentration', phys_decomp)
    call addfld('num_a1_logv', 'kg/kg ',pver, 'A','num_a1 log^2 concentration', phys_decomp)

    call addfld('so4_a2_logv', 'kg/kg ',pver, 'A','so4_a2 log^2 concentration', phys_decomp)
    call addfld('soa_a2_logv', 'kg/kg ',pver, 'A','soa_a2 log^2 concentration', phys_decomp)
    call addfld('ncl_a2_logv', 'kg/kg ',pver, 'A','ncl_a2 log^2 concentration', phys_decomp)
    call addfld('num_a2_logv', 'kg/kg ',pver, 'A','num_a2 log^2 concentration', phys_decomp)

    call addfld('so4_a3_logv', 'kg/kg ',pver, 'A','so4_a3 log^2 concentration', phys_decomp)
    call addfld('dst_a3_logv', 'kg/kg ',pver, 'A','dst_a3 log^2 concentration', phys_decomp)
    call addfld('ncl_a3_logv', 'kg/kg ',pver, 'A','ncl_a3 log^2 concentration', phys_decomp)
    call addfld('num_a3_logv', 'kg/kg ',pver, 'A','num_a3 log^2 concentration', phys_decomp)
! JHYoon
...
! JHYoon
             if(trim(solsym(m)).eq.'so4_a1') then
             call outfld('so4_a1_logm', log(mmr(:ncol,:,m)), ncol ,lchnk )
             call outfld('so4_a1_logv', log(mmr(:ncol,:,m))**2., ncol ,lchnk )
             end if
             if(trim(solsym(m)).eq.'pom_a1') then
             call outfld('pom_a1_logm', log(mmr(:ncol,:,m)), ncol ,lchnk )
             call outfld('pom_a1_logv', log(mmr(:ncol,:,m))**2., ncol ,lchnk )
             end if
             if(trim(solsym(m)).eq.'soa_a1') then
             call outfld('soa_a1_logm', log(mmr(:ncol,:,m)), ncol ,lchnk )
             call outfld('soa_a1_logv', log(mmr(:ncol,:,m))**2., ncol ,lchnk )
             end if
             if(trim(solsym(m)).eq.'dst_a1') then
             call outfld('dst_a1_logm', log(mmr(:ncol,:,m)), ncol ,lchnk )
             call outfld('dst_a1_logv', log(mmr(:ncol,:,m))**2., ncol ,lchnk )
             end if
             if(trim(solsym(m)).eq.'ncl_a1') then
             call outfld('ncl_a1_logm', log(mmr(:ncol,:,m)), ncol ,lchnk )
             call outfld('ncl_a1_logv', log(mmr(:ncol,:,m))**2., ncol ,lchnk )
             end if
             if(trim(solsym(m)).eq.'bc_a1') then
             call outfld('bc_a1_logm', log(mmr(:ncol,:,m)), ncol ,lchnk )
             call outfld('bc_a1_logv', log(mmr(:ncol,:,m))**2., ncol ,lchnk )
             end if
             if(trim(solsym(m)).eq.'num_a1') then
             call outfld('num_a1_logm', log(mmr(:ncol,:,m)), ncol ,lchnk )
             call outfld('num_a1_logv', log(mmr(:ncol,:,m))**2., ncol ,lchnk )
             end if

             if(trim(solsym(m)).eq.'so4_a2') then
             call outfld('so4_a2_logm', log(mmr(:ncol,:,m)), ncol ,lchnk )
             call outfld('so4_a2_logv', log(mmr(:ncol,:,m))**2., ncol ,lchnk )
             end if
             if(trim(solsym(m)).eq.'soa_a2') then
             call outfld('soa_a2_logm', log(mmr(:ncol,:,m)), ncol ,lchnk )
             call outfld('soa_a2_logv', log(mmr(:ncol,:,m))**2., ncol ,lchnk )
             end if
             if(trim(solsym(m)).eq.'ncl_a2') then
             call outfld('ncl_a2_logm', log(mmr(:ncol,:,m)), ncol ,lchnk )
             call outfld('ncl_a2_logv', log(mmr(:ncol,:,m))**2., ncol ,lchnk )
             end if
             if(trim(solsym(m)).eq.'num_a2') then
             call outfld('num_a2_logm', log(mmr(:ncol,:,m)), ncol ,lchnk )
             call outfld('num_a2_logv', log(mmr(:ncol,:,m))**2., ncol ,lchnk )
             end if

             if(trim(solsym(m)).eq.'so4_a3') then
             call outfld('so4_a3_logm', log(mmr(:ncol,:,m)), ncol ,lchnk )
             call outfld('so4_a3_logv', log(mmr(:ncol,:,m))**2., ncol ,lchnk )
             end if
             if(trim(solsym(m)).eq.'dst_a3') then
             call outfld('dst_a3_logm', log(mmr(:ncol,:,m)), ncol ,lchnk )
             call outfld('dst_a3_logv', log(mmr(:ncol,:,m))**2., ncol ,lchnk )
             end if
             if(trim(solsym(m)).eq.'ncl_a3') then
             call outfld('ncl_a3_logm', log(mmr(:ncol,:,m)), ncol ,lchnk )
             call outfld('ncl_a3_logv', log(mmr(:ncol,:,m))**2., ncol ,lchnk )
             end if
             if(trim(solsym(m)).eq.'num_a3') then
             call outfld('num_a3_logm', log(mmr(:ncol,:,m)), ncol ,lchnk )
             call outfld('num_a3_logv', log(mmr(:ncol,:,m))**2., ncol ,lchnk )
             end if
! JHYoon
          endif
