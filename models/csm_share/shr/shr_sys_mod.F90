!===============================================================================
! SVN $Id: shr_sys_mod.F90 81681 2016-11-15 18:04:18Z jedwards $
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/csm_share/branch_tags/cesm1_1_1_LENS_control_tags/cesm1_1_1_LENS_control_n01_share3_121022/shr/shr_sys_mod.F90 $
!===============================================================================
...
!-------------------------------------------------------------------------------
   rcode = 0
#ifdef HAVE_EXECUTE    
   call execute_command_line(str,status=rcode)   ! Intrinsic as of F2008
#else
#if (defined CRAY) || (defined UNICOSMP)
...
#elif (defined OSF1 || defined SUNOS || defined LINUX || defined NEC_SX || defined Darwin)
