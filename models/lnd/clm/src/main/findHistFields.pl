...
#
  ...
  my $svnurl = '$URL: https://svn-ccsm-models.cgd.ucar.edu/clm2/branch_tags/cesm1_1_x_LENS_tags/cesm1_1_x_LENS_n05_clm4_0_54/models/lnd/clm/src/main/findHistFields.pl $';
