...
!-----------------------------------------------------------------------
    ...
    str = &
'$HeadURL: https://svn-ccsm-models.cgd.ucar.edu/clm2/branch_tags/cesm1_1_x_LENS_tags/cesm1_1_x_LENS_n05_clm4_0_54/models/lnd/clm/tools/mksurfdata_map/src/mkfileMod.F90 $'
    call check_ret(nf_put_att_text (ncid, NF_GLOBAL, &
         'Version', len_trim(str), trim(str)), subname)

    str = '$Id: mkfileMod.F90 40601 2012-09-28 03:37:55Z sacks $'
    call check_ret(nf_put_att_text (ncid, NF_GLOBAL, &
