!===============================================================================
! SVN $Id: seq_infodata_mod.F90 41525 2012-11-03 00:19:43Z tcraig $
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/drv/seq_mct/branch_tags/cesm1_1_0_rel_tags/cesm1_1_0_n03_drvseq4_2_08/shr/seq_infodata_mod.F90 $
!===============================================================================
!BOP ===========================================================================
!
...
!EOP
    ...
    namelist /seq_infodata_inparm/  &
         ...
         reprosum_use_ddpdd, reprosum_diffmax
...
!-------------------------------------------------------------------------------
    ...
    if ( present(flux_epbalfact) ) then
       ...
       if (trim(infodata%flux_epbal) == 'ocn') then 
          flux_epbalfact = infodata%precip_fact * 1.0e-6_SHR_KIND_R8
       end if
