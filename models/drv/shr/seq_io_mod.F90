!===============================================================================
! SVN $Id: seq_io_mod.F90 86977 2017-10-12 21:17:03Z nanr $
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/drv/seq_mct/branch_tags/cesm1_1_0_rel_tags/cesm1_1_0_n03_drvseq4_2_08/shr/seq_io_mod.F90 $
!===============================================================================
!BOP ===========================================================================
!
...
module seq_io_mod
  ...
  use shr_kind_mod, only: r8 => shr_kind_r8, in => shr_kind_in, r4 => shr_kind_r4
...
! "v0"    name1 = trim(prefix)//trim(dname)//'_'//trim(itemc)
	  ...
	  if (luse_float) then
             ...
             rcode = pio_put_att(cpl_io_file,varid,"_FillValue",real(lfillvalue, r8))
          end if
