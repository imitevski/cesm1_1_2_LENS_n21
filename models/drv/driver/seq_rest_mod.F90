!===============================================================================
! SVN $Id: seq_rest_mod.F90 40372 2012-09-18 23:34:49Z tcraig $
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/drv/seq_mct/branch_tags/cesm1_1_0_rel_tags/cesm1_1_0_n03_drvseq4_2_08/driver/seq_rest_mod.F90 $
!===============================================================================
!BOP ===========================================================================
!
...
!-------------------------------------------------------------------------------
   ...
   if (iamin_CPLID) then
      ...
      if (rof_present .and. ocnrof_prognostic) then
         call seq_cdata_setptrs(cdata_rx,gsmap=gsmap)
         call seq_io_read(rest_file,gsmap,r2oacc_rx,'r2oacc_rx')
         call seq_io_read(rest_file,      r2oacc_rx_cnt,'r2oacc_rx_cnt')
      endif
      if (glc_present) then
...
!!            call seq_io_redef(rest_file)
         ...
         if (rof_present .and. ocnrof_prognostic) then
            call seq_cdata_setptrs(cdata_rx,gsmap=gsmap)
            call seq_io_write(rest_file,gsmap,r2oacc_rx,'r2oacc_rx',whead=whead,wdata=wdata)
            call seq_io_write(rest_file,      r2oacc_rx_cnt,'r2oacc_rx_cnt',whead=whead,wdata=wdata)
         endif
         if (glc_present) then
            call seq_cdata_setptrs(cdata_gx,gsmap=gsmap)
