!===============================================================================
! SVN $Id: seq_diag_mct.F90 41525 2012-11-03 00:19:43Z tcraig $
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/drv/seq_mct/branch_tags/cesm1_1_0_rel_tags/cesm1_1_0_n03_drvseq4_2_08/driver/seq_diag_mct.F90 $
!===============================================================================
!BOP ===========================================================================
!
...
!-------------------------------------------------------------------------------
   ...
   if (present(x2o_o)) then
      if (first_time) then
       ...
       ! index_x2o_Forr_roff   = mct_aVect_indexRA(x2o_o,'Forr_roff') 
       ! index_x2o_Forr_ioff   = mct_aVect_indexRA(x2o_o,'Forr_ioff') 
      end if
