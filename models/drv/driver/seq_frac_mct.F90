!===============================================================================
! SVN $Id: seq_frac_mct.F90 41525 2012-11-03 00:19:43Z tcraig $
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/drv/seq_mct/branch_tags/cesm1_1_0_rel_tags/cesm1_1_0_n03_drvseq4_2_08/driver/seq_frac_mct.F90 $
!===============================================================================
!BOP ===========================================================================
!
...
subroutine seq_frac_init(cdata_a, cdata_i, cdata_l, cdata_o, cdata_g, cdata_r, &
...
!EOP
   ...
   type(mct_gGrid), pointer :: dom_r   ! pointer to component domain
...
subroutine seq_frac_set(i2x_i, cdata_a, cdata_i, cdata_l, cdata_o, cdata_g, cdata_r, &
                         ice_present, ocn_present, lnd_present, glc_present, &
                         rof_present, &
                         fractions_a, fractions_i, fractions_l, fractions_o, &
                         fractions_g, fractions_r, &
...
! !INPUT/OUTPUT PARAMETERS:
   ...
   logical        , intent(in)    :: glc_present   ! true => glc is present
   logical        , intent(in)    :: rof_present   ! true => glc is present
