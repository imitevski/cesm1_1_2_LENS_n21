...
!
! !REVISION HISTORY:
!  SVN:$Id: forcing.F90 47397 2013-05-22 15:33:53Z jedwards $
!
! !USES:
...
!BOC
   ...
   integer (int_kind) :: &
      ...
      tavg_TAUX_2,       &! tavg_id for wind stress in X direction, stream #2 (allows two frequencies)
      tavg_TAUX2,        &! tavg_id for wind stress**2 in X direction
      tavg_TAUY,         &! tavg_id for wind stress in Y direction
      tavg_TAUY_2,       &! tavg_id for wind stress in Y direction, stream #2 (allows two frequencies)
